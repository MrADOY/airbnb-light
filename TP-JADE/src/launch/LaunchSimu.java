...
public class LaunchSimu {
	...
	public static void main(String... args) {
		...
		lesAgents.append("agentCar:agents.AgenceAgent(ressources/car.csv);");
		lesAgents.append("agentBus:agents.AgenceAgent(ressources/bus.csv);");
		lesAgents.append("agentTrain:agents.AgenceAgent(ressources/train.csv);");
