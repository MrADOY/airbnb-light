...
public class Journey implements Cloneable, Serializable{
    ...
    private static String PLACES = ", nb places";
	...
	public Journey(final String _start, final String _stop, final String _means, final int _departureDate,
				   final int _duration, final double _cost, final int _co2, final int _confort, final int nbPlaces) {
		this(_start, _stop, _means, _departureDate, _duration, _cost);
		co2 = _co2;
		confort = _confort;
		places = nbPlaces;
	...
	public Journey(final String _start, final String _stop, final String _means, final int _departureDate,
				   final int _duration, final double _cost, final int _co2, final int _confort, String _proposedBy, final int nbPlaces) {
		this(_start, _stop, _means, _departureDate, _duration, _cost, _co2, _confort, nbPlaces);
		proposedBy = _proposedBy;
	}
	...
	public String toString() {
	    return new StringBuilder(Journey.TRAJECTFROM).append(start).append(Journey.TO).
				...
				append(Journey.PLACES).append(places).toString();
	}
	...
	public boolean equals(Object o) {
		...
		return duration == journey.duration &&
				departureDate == journey.departureDate &&
				arrivalDate == journey.arrivalDate &&
				Double.compare(journey.cost, cost) == 0 &&
				co2 == journey.co2 &&
				confort == journey.confort &&
				places == journey.places &&
				Objects.equals(start, journey.start) &&
				Objects.equals(stop, journey.stop) &&
				Objects.equals(means, journey.means) &&
				Objects.equals(proposedBy, journey.proposedBy);
	}

	@Override
	public int hashCode() {

		return Objects.hash(start, stop, means, duration, departureDate, arrivalDate, cost, co2, confort, proposedBy, places);
	}
